        ...
        <div class="box-body">
          <table class="table">
            ...
            <div class="form-group">
              <form role="form" class="form-horizontal" action="http://localhost/Arya%20Shop/main.php?module=data_proses" method="POST" name="formcari">
            ...
            <td >
            <div class="form-group">
              <form role="form" class="form-horizontal" action="http://localhost/Arya%20Shop/main.php?module=data_proses" method="POST" name="formproses">
                <input type="hidden" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="tanggal_awal" autocomplete="off" value="<?php echo $isiawal; ?>">
                <input type="hidden" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="tanggal_akhir" autocomplete="off" value="<?php echo $isiakhir; ?>" >
                <table>
                  <thead>
                    <h3>Input Nilai Support & Confidence</h3>
                  </thead>
                  <tbody>
                  <tr>
                    <td>
                      <input type="text" class="form-control" id="min_support" name="min_support" placeholder="Min Support" required>
                    </td>
                    <td>
                      <label class="col-sm-4 control-label">&</label>
                    </td>
                    <td>
                    <input type="text" class="form-control" id="min_confidence" name="min_confidence" placeholder="Min Confidence" required>
                    </td>
                  </tr>
                  </tbody>
                </table>
                <div class="box-footer">
                  <div class="form-group">
                      <input type="submit" class="btn btn-primary btn-submit" name="proses" value="Proses">
                  </div>
                </div><!-- /.box footer -->
              </form>
            </div>
