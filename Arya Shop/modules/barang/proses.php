...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO tb_barang(kode_barang,nama_barang,kategori,harga_beli,harga_jual,satuan,created_user,updated_user) 
                                            VALUES('$kode_barang','$nama_barang','$kategori','$harga_beli','$harga_jual','$satuan','$created_user','$created_user')")
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            $query = mysqli_query($mysqli, "DELETE FROM tb_barang WHERE kode_barang='$kode_barang'")
