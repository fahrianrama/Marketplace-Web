...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Arya Shop</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Arya Shop">
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=beranda" class="logo"><span style="font-size: 18px">Arya Shop</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 - <a href="">Arya Shop</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
