...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Fiesta Food Retailer</title>
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=beranda" class="logo"><span style="font-size: 18px">Fiesta Food Retailer</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 - <a href="">Fiesta Food Retailer</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
