...
<section class="content-header">
  <h1>
    <i class="fa fa-user icon-title"></i> Manajemen Agen
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <?php
              ...
              echo "      <a data-toggle='tooltip' data-placement='top' title='Ubah' class='btn btn-primary btn-sm' href='?module=form_user&form=edit&id=$data[id_user]'>
                          ...
                          ?>
                          <a data-toggle='tooltip' data-placement='top' title='Hapus' class='btn btn-primary btn-sm' href='modules/user/proses.php?act=delete&id=<?php echo $data["id_user"];?>'>
