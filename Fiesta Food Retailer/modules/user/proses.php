			...
			if (in_array($extension, $allowed_extensions)) {
				...
				if($ukuran_file <= 1000000) { // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
					...
					if(move_uploaded_file($tmp_file, $path_file)) { // Cek apakah gambar berhasil diupload atau tidak
						...
						// perintah query untuk menambah data pada tabel users
						$query = mysqli_query($mysqli, "INSERT INTO tb_user(username,password,nama_user,email,telepon,foto,hak_akses)
												VALUES('$username','$password','$nama_user','$email','$telepon','$nama_file','$hak_akses')")
