            ...
            <div class="table100">
                ...
                >
                    ...
                    <div class="d-flex justify-content-center align-items-center h-100">
                        ...
                        <h1 class="mb-3">Menu Produk Toko Donat Al-Fatih</h1>
                ...
                <!-- Background image -->
            <a class='btn btn-info btn-block mb-3' href="form_produk.php?aksi=tambah">Tambah</a>
                <table>
                    <thead>
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM tb_produk ORDER BY id_produk ASC LIMIT $bts_mulai, $bts";
                        ...
                        <tr scope="row">
                            ...
                            <td><a class='btn btn-dark btn-sm' href="form_produk.php?aksi=edit&id=<?php echo $data['id_produk']?>">Edit</a>
                                <a class='btn btn-dark btn-sm' href="form_produk.php?aksi=hapus&id=<?php echo $data['id_produk']?>">Delete</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
                <?php
                    $query_jumlah = "SELECT count(*) AS jumlah FROM tb_produk";
