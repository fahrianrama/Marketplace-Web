...
<img src="images/login_cover.jpg" width="100%" alt="">
<div style="position:absolute; top:40px; left:70px; color:white">
	<img src="images/profile.jpg" alt="" style="border-radius: 50%; height:80px;">
</div>
<?php 
...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
  ...
  if ($_GET["module"]=="barang" || $_GET["module"]=="form_barang") { ?>
    <li class="active">
      <a href="?module=barang"><i class="fa fa-folder"></i> Produk </a>
      </li>
  <?php
  }
	...
	if ($_GET["module"]=="barang_masuk") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
				...
				<li><a href="?module=barang_keluar"><i class="fa fa-level-up"></i> Pengajuan Cabang </a></li>
      		</ul>
    	</li>
    <?php
	}
		...
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
				...
				<li class="active"><a href="?module=barang_keluar"><i class="fa fa-level-up"></i> Pengajuan Cabang </a></li>
      		</ul>
    	</li>
    <?php
	}
  ...
  <?php
	...
	if ($_GET["module"]=="user" || $_GET["module"]=="form_user") { ?>
		<li class="active">
			<a href="?module=user"><i class="fa fa-user"></i> Profil Cabang</a>
	  	</li>
	<?php
	}
...
<?php
	...
	if ($_GET["module"]=="barang_masuk") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		<li class="active"><a href="?module=barang_masuk"><i class="fa fa-level-down"></i> Barang Masuk </a></li>
				<li><a href="?module=barang_keluar"><i class="fa fa-level-up"></i> Pengajuan Stok </a></li>
      		</ul>
    	</li>
    <?php
	}
		...
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		<li><a href="?module=barang_masuk"><i class="fa fa-level-down"></i> Barang Masuk </a></li>
				<li class="active"><a href="?module=barang_keluar"><i class="fa fa-level-up"></i> Pengajuan Stok </a></li>
      		</ul>
    	</li>
    <?php
	}
