...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Management Kopi Rindu</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Management Kopi Rindu">
    <meta name="author" content="Rama Vito" />
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header" style="background-color:white;">
        <!-- Logo -->
        <a href="?module=beranda" class="logo" style="color:black;background-color:white;"><span><img src="images/logogj.png" height="70%" alt=""></span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2022 - <a href="">Management Kopi Rindu</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
