...
$query = mysqli_query($mysqli, "SELECT id_user, nama_user, foto, hak_akses FROM tb_user WHERE id_user='$_SESSION[id_user]'")
...
<li class="dropdown user user-menu" style="background-color: #ecf0f5;">
  ...
  ?>
    ...
    <span class="hidden-xs" style="color: black;"><?php echo $data['nama_user']; ?> <i style="margin-left:5px" class="fa fa-angle-down"></i></span>
  </a>
