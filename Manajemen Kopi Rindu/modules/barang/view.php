...
<section class="content-header">
  <h1>
    ...
    <a class="btn btn-success btn-social pull-right" style="margin-right:20px;" href="?module=barang_masuk" title="Tambah Stok" data-toggle="tooltip">
          ...
          <table id="dataTables1" class="table table-bordered table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Biaya Bahan</th>
            ...
            $query = mysqli_query($mysqli, "SELECT kode_barang,nama_barang,kategori,harga_beli,harga_jual,satuan,stok FROM tb_barang ORDER BY kode_barang DESC")
