<script type="text/javascript">
  function tampil_barang(input){
    ...
    $.post("modules/barang-keluar/barang2.php", {
      dataidbarang: num,
    }, function(response) {      
      $('#stok').html(response)
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/barang-keluar/proses.php?act=insertpes" method="POST" name="formBarangKeluar">
            <div class="box-body">
              <?php  
              // fungsi untuk membuat kode transaksi
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(kode_transaksi,7) as kode FROM tb_pesanan
              ...
              <div class="form-group">
               ...
               <div class="col-sm-5">
                  <select class="chosen-select" name="kode_barang" data-placeholder="-- Pilih Barang --" onchange="tampil_barang(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
                      $query_barang = mysqli_query($mysqli, "SELECT kode_barang, nama_barang FROM tb_stok WHERE stok>0 ORDER BY nama_barang ASC")
